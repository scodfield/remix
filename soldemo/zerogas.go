...
// ZeroGasMetaData contains all meta data concerning the ZeroGas contract.
var ZeroGasMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"SayHi\",\"outputs\":[{\"internalType\":\"string\",\"name\":\"\",\"type\":\"string\"}],\"stateMutability\":\"pure\",\"type\":\"function\"}]",
}

// ZeroGasABI is the input ABI used to generate the binding from.
// Deprecated: Use ZeroGasMetaData.ABI instead.
var ZeroGasABI = ZeroGasMetaData.ABI
...
func bindZeroGas(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := ZeroGasMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// SayHi is a free data retrieval call binding the contract method 0x9c6dd5d4.
//
// Solidity: function SayHi() pure returns(string)
func (_ZeroGas *ZeroGasCaller) SayHi(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _ZeroGas.contract.Call(opts, &out, "SayHi")
...
//
// Solidity: function SayHi() pure returns(string)
func (_ZeroGas *ZeroGasSession) SayHi() (string, error) {
	return _ZeroGas.Contract.SayHi(&_ZeroGas.CallOpts)
}

// SayHi is a free data retrieval call binding the contract method 0x9c6dd5d4.
//
// Solidity: function SayHi() pure returns(string)
func (_ZeroGas *ZeroGasCallerSession) SayHi() (string, error) {
	return _ZeroGas.Contract.SayHi(&_ZeroGas.CallOpts)
}
